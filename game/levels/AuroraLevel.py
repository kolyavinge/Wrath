...
class AuroraLevel(Level):
    ...
    def makeMainRoom(self):
        ...
        self.builder.buildFloor(Vector3(16, 8, 0), 12, 12, Material.floorConcrete1)
    ...
    def makeLeftRoom(self):
        ...
        self.builder.buildFloor(Vector3(9, 10, 0), 5, 8, Material.floorConcrete1)
    ...
    def makeBottomRoom(self):
        ...
        self.builder.buildFloor(Vector3(16, 1, 0), 12, 5, Material.floorConcrete1)
    ...
    def makeLeftRoomPass(self):
        ...
        self.builder.buildFloor(Vector3(14, 13, 0), 2, 2, Material.floorConcrete1)
    ...
    def makeBottomRoomPass(self):
        ...
        self.builder.buildFloor(Vector3(21, 6, 0), 2, 2, Material.floorConcrete1)
    ...
    def makeLeftBottomRoomPass(self):
        ...
        self.builder.buildFloor(Vector3(10, 6, 0), 3, 4, Material.floorConcrete1)
        ...
        self.builder.buildFloor(Vector3(10, 2, 0), 4, 4, Material.floorConcrete1)
        ...
        self.builder.buildFloor(Vector3(14, 2, 0), 2, 3, Material.floorConcrete1)
    ...
    def makeRightPass(self):
        ...
        self.builder.buildFloor(Vector3(28, 2.5, 0), 4, 2, Material.floorConcrete1)
        ...
        self.builder.buildFloor(Vector3(30, 6.5, 2), 2, 8.5, Material.floorConcrete1)
