...
class GameInitializer:
    ...
    def initClient(self, client):
        ...
        self.personInitializer.initEnemiesForLevel(client.gameState, level)
    ...
    def initServer(self, server):
        ...
        self.personIdLogic.resetEnemyId()
        self.personInitializer.initPlayer(server.gameState, *level.getPlayerInitInfo())
        self.personInitializer.initEnemiesForLevel(server.gameState, level)
