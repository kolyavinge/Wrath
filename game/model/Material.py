...
Material.wallMetal1 = Material(MaterialKind.metal, 0.2, 1.0, 0.5, 8.0)
Material.wallMetal2 = Material(MaterialKind.metal, 0.2, 1.0, 0.5, 8.0)
Material.wallMetal3 = Material(MaterialKind.metal, 0.2, 1.0, 0.5, 8.0)
Material.wallMetal4 = Material(MaterialKind.metal, 0.2, 1.0, 0.5, 8.0)
Material.wallMetal5 = Material(MaterialKind.metal, 0.2, 1.0, 0.5, 8.0)
Material.wallMetal6 = Material(MaterialKind.metal, 0.2, 1.0, 0.5, 8.0)
Material.wallMetal7 = Material(MaterialKind.metal, 0.2, 1.0, 0.5, 8.0)
Material.wallMetal8 = Material(MaterialKind.metal, 0.2, 1.0, 0.5, 8.0)
