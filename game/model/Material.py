...
Material.plasmaBullet = Material(MaterialKind.metal, 1.0, 0.0, 0.0, 1.0)
Material.launcherBullet = Material(MaterialKind.metal, 0.2, 0.5, 0.5, 8.0)
...
Material.plasmaHole = Material(MaterialKind.none, 0.2, 0.1, 0.1, 1.0)
