from game.vox.audio.AudioBufferLoader import AudioBufferLoader
...
class AudioBufferCollection:
    ...
    def init(self):
        ...
        self.rifleGrenadeShot = loadWav("rifleGrenadeShot")
        self.rifleGrenadeExplosion = loadWav("rifleGrenadeExplosion")
