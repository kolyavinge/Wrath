...
class BackgroundRenderer:
    ...
    def init(self, backgroundVisibility):
        sphereElementsCountHalf = backgroundVisibility.sphere.elementsCount
    ...
    def render(self, backgroundVisibility, camera):
        self.updateVBOIfNeeded(backgroundVisibility)
    ...
    def updateVBOIfNeeded(self, backgroundVisibility):
        if self.visibleSphereElements == backgroundVisibility.visibleSphereElements:
            return
        self.visibleSphereElements = backgroundVisibility.visibleSphereElements
        self.vbo.reset()
