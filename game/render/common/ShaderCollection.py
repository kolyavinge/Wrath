...
from game.render.lib.Shader import ShaderType
from game.render.lib.ShaderCompiler import ShaderCompiler
...
class ShaderCollection:
    ...
    def init(self):
        ...
        self.common = self.shaderCompiler.compile(path + "common.glsl", ShaderType.vertex)
